...
$top_rated_query = "SELECT * FROM movies WHERE category = 'movie' ORDER BY rating DESC LIMIT 8";
$top_rated_movies = $db->query($top_rated_query)->fetchAll(PDO::FETCH_ASSOC);

// Ambil data film untuk section "Upcoming"
$upcoming_query = "SELECT * FROM movies ORDER BY year DESC LIMIT 4";
$upcoming_movies = $db->query($upcoming_query)->fetchAll(PDO::FETCH_ASSOC);
...
<body id="top">
  ...
  <main>
        ...
        <div class="container">
          ...
          <div class="flex-wrapper">
            ...
            <div class="title-wrapper">
              <p class="section-subtitle">Discover the Latest Upcoming Movies</p>
    ...
    <div class="container">
        ...
        <ul class="movies-list" id="top-rated-movies">
